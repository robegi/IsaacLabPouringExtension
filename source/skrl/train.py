...
class Policy(GaussianMixin, Model):
    def __init__(self, observation_space, action_space, device, clip_actions=False,
                 ...
                 num_envs=1, num_layers=1, hidden_size=512, sequence_length=32):
    ...
    def compute(self, inputs, role):
        ...
        # Pendulum-v1 action_space is -1 to 1
...
# path = "/home/asad/IsaacLabPouringExtension/runs/torch/pouring_ppo/Test_0/checkpoints/best_agent.pt"
# agent.load(path)
